...
import 'package:cool_weather_2022/utils/translation_utils.dart';
...
class ShareUtils {
  ...
  static Future<Uint8List?> createWeatherCard(
    ...
    // 是否是白天
    bool isDay = MyDateUtils.isDay(weatherBean);
    ...
    TextPainter districtTp = createTextPainter(
        ...
        text2: '    ' + MyDateUtils.getCurrentTimeMMDD(), fontSize2: 35);
    districtTp.paint(canvas, const Offset(50, 40));
    ...
    TextPainter weatherTp = createTextPainter(
        ...
        45,
        FontWeight.w400);
    weatherTp.paint(canvas, const Offset(50, 350));
